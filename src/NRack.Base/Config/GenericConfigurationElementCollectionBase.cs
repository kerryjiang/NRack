...
namespace NRack.Base.Config
{
    ...
    /// <summary>
    /// Generic ConfigurationElement CollectionBase
    /// </summary>
    /// <typeparam name="TConfigElement">The type of the configuration element.</typeparam>
    public class GenericConfigurationElementCollectionBase<TConfigElement> : ConfigurationElementCollection, IEnumerable<TConfigElement>
        where TConfigElement : ConfigurationElement, new()
    {
        ...
        /// A <see cref="T:System.Collections.Generic.IEnumerator`1"/> that can be used to iterate through the collection.
        /// </returns>
        public new IEnumerator<TConfigElement> GetEnumerator()
        {
            int count = base.Count;
